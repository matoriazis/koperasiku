        ...
        <div class="card-content">
            <form action="{{route('officer.savings.store')}}" method="POST"> @csrf
                <div class="form-group">
                    ...
                    <select style="padding-top: 2px" id="select" required aria-placeholder="Hahay"
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control" required style="padding: 10px;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="amount" id="amount" class="form-control" required placeholder="Jumlah Setoran">
                    <div id="amount_text" style="font-weight: 600; margin-top: 10px;"></div>
                </div>
                <div style="float: right">
                    <button type="submit" onclick="return confirm('Pastikan data yang anda masukan benar. simpan?')" class="btn btn-success">Simpan</button>
                </div>
            </form>
        </div>
    </div>
